...
import dev.pthomain.android.dejavu.persistence.statistics.database.DatabaseStatisticsCompiler
import dev.pthomain.android.dejavu.persistence.statistics.file.FileStatisticsCompiler
...
internal abstract class StatisticsModule<E>
    ...
    @Provides
    @Singleton
    fun provideDatabaseStatisticsCompiler(configuration: Configuration<E>,
                                          logger: Logger,
