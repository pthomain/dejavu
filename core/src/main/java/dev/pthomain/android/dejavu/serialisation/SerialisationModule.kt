...
@Module
internal abstract class SerialisationModule<E> where E : Throwable,
                                                     E : NetworkErrorPredicate {
    @Provides
    @Singleton
    fun provideSerialiser(configuration: Configuration<E>) =
            configuration.serialiser

    @Provides
    @Singleton
    fun provideEncryptionManager(configuration: Configuration<E>) =
    ...
    @Provides
    @Singleton
    fun provideSerialisationManagerFactory(configuration: Configuration<E>,
