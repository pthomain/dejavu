...
//    fun setUp() {
//        mockInterceptorFactory = mock<DejaVuInterceptor.Factory<*>>(DejaVuInterceptor.Factory<*>::class.java)
//        mockCallAdapter = mock(CallAdapter<*, *>::class.java)
//
//        target = RetrofitCallAdapter(
...
//        val mockCacheInterceptor = mock(DejaVuInterceptor<*>::class.java)
